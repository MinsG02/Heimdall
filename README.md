...
============================================================================================
🛡️ Project Heimdall: Git 협업 가이드

1. 🌅 작업 시작 전: 메인 코드 가져오기 (Sync)
- "남들이 작업한 최신 코드를 내 컴퓨터로 가져오는 단계"입니다.

# 1. 메인 브랜치로 이동
  git checkout main

# 2. 원격 저장소(GitHub)의 최신 main 내용을 당겨오기
  git pull origin main

============================================================================================

2. 🌿 내 브랜치 만들고 이동하기
- "이제 내 작업을 시작할 격리된 공간을 만드는 단계"입니다.
- [처음 만들 때]
# feature/이니셜 형식 (예: feature/kms)
...
- 내가 작업하는 동안 main이 바뀌었을 수도 있습니다. 내 브랜치에도 최신 내용을 반영해줘야 충돌이 안 납니다.
...
# 2. 로컬에 저장(커밋)하기 (메시지는 명확하게!)
git commit -m "마이크 센서 데이터 수신 기능 추가"

# 3. 내 원격 브랜치(GitHub)로 쏘기
